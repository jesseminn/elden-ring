...
OUT = ROOT / "data.js"
OUT_JSON = ROOT / "data" / "walkthrough.json"
...
def main():
    ...
    js = "// 自動產生，請勿手動編輯。修改請改 scripts/parse.py 後重新執行。\n"
    js += "window.ELDEN_DATA = " + json.dumps(data, ensure_ascii=False) + ";\n"

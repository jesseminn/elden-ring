...
// 5) 配點工具（header 按鈕，非分頁）：渲染 + 「記錄 +1」升級並持久化 buildLv
click($(".build-toggle")); await wait();
console.log("5) 配點工具渲染:", !!$(".build-view"), "| 分頁列無 active:", $$(".tab.active").length === 0, "| 附近時間軸列數:", $$(".build-view .build-tl-row").length);
